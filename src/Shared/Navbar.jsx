...
const Navbar = () => {
    ...
    return (
        <nav className="bg-white shadow-md px-6 py-4.5 sticky top-0 z-50">
            <div className="max-w-7xl mx-auto flex justify-between items-center">
                {/* Logo */}
                <h1 className="text-3xl font-bold text-purple-600 tracking-wide cursor-pointer hover:text-purple-800 transition-colors">
                    Smart
                </h1>
